...
public class GoogleActivity extends AppCompatActivity {
    ...
    public void  btnuno(View view){
        ...
        if (!email.isEmpty() && !password.isEmpty()) {
            ...
            Toast.makeText(GoogleActivity.this, "complete los campos", Toast.LENGTH_SHORT).show();
        }
        ...
        mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(GoogleActivity.this, "contraseña incorrecta", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void reg(View view){
        startActivity(new Intent(GoogleActivity.this,RegistroActivity.class));
        finish();
    }
